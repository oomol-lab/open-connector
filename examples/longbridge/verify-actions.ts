import type { LongbridgeActionName } from "../../src/providers/longbridge/actions.ts";

import { writeFile } from "node:fs/promises";
import { resolve } from "node:path";
import { fileURLToPath } from "node:url";
import { longbridgeActions } from "../../src/providers/longbridge/actions.ts";
import { longbridgeReadonlyActionSpecs } from "../../src/providers/longbridge/readonly-action-specs.ts";
import { longbridgeVerificationSamples } from "../../src/providers/longbridge/verification-samples.ts";
import { runtimeHeaders } from "../local-http/client.ts";
...
function printUsage(): void {
  console.log(`Usage:
  node examples/longbridge/verify-actions.ts [options]
