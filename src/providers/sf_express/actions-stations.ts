...
export const sfExpressStationActions: ActionDefinition[] = [
  ...
  defineProviderAction(service, {
    ...
    inputSchema: s.object(
      "The outsourcing record to submit.",
      {
        ...
        exit_reason_type: s.nonEmptyString("The exit reason category; required when service_sign_state is 3."),
        ...
        exit_employee_destination: s.nonEmptyString(
          "Where exiting employees went; required when service_sign_state is 3.",
        ),
  ...
  defineProviderAction(service, {
    ...
    inputSchema: s.object(
      "The inspection images to submit.",
      {
        ...
        light_box: s.stringArray("The light-box image file names."),
        image_wall: s.stringArray("The image-wall file names."),
        girdle: s.stringArray("The girdle glass-sticker file names."),
        cooperation_license: s.stringArray("The cooperation-plate file names."),
        business_poster: s.stringArray("The business-poster file names."),
        pickup_poster: s.stringArray("The self-pickup poster file names."),
        pickup_desk: s.stringArray("The pickup-desk card file names."),
        wall_system: s.stringArray("The wall-system file names."),
        hanging_flags: s.stringArray("The hanging-flag file names."),
        reception_desk: s.stringArray("The reception-desk file names."),
        shelf_stickers: s.stringArray("The shelf-sticker file names."),
        indication: s.stringArray("The indication file names."),
        tips: s.stringArray("The tips file names."),
        carton_desk: s.stringArray("The carton-recycling-desk file names."),
      },
      {
        optional: [
          "extend_json",
  ...
  defineProviderAction(service, {
    ...
    outputSchema: stationAckOutputSchema("The waybill number the SMS was sent for."),
  }),
  defineProviderAction(service, {
