...
const receiptFeeSchema = s.object(
  "One fee entry for the receipt.",
  {
    ...
    customerAcctCode: s.nonEmptyString("The payment account; required for monthly settlement, empty for cash."),
...
export const sfExpressStationActions: ActionDefinition[] = [
  ...
  defineProviderAction(service, {
    ...
    inputSchema: s.object(
      "The outsourcing record to submit.",
      {
        ...
        service_state: s.stringEnum("The service state.", ["1", "2"]),
        ...
        this_month_leave_employee: s.nonEmptyString("Employees who left this month, separated by ';' (may be empty)."),
        last_month_leave_employee: s.nonEmptyString("Employees who left last month, separated by ';' (may be empty)."),
  ...
  defineProviderAction(service, {
    ...
    outputSchema: s.unknownObject("The OSS token record; the documented response carries the token fields in obj."),
  }),
  defineProviderAction(service, {
