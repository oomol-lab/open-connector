...
export const baiduMapsActions: ActionDefinition[] = [
  action(
    ...
    s.requiredObject("Input parameters for geocoding an address.", {
  ...
  action(
    ...
    s.requiredObject("Input parameters for reverse geocoding.", {
  ...
  action(
    ...
    s.requiredObject("Input parameters for searching places.", {
      ...
      city_limit: s.integer("Whether to restrict results to the supplied region (1) or extend to nearby regions (0)."),
  ...
  action(
    ...
    s.requiredObject("Input parameters for circular place search.", {
      query: s.nonEmptyString("The keyword used to search places."),
  ...
  action(
    ...
    s.requiredObject("Input parameters for rectangular place search.", {
      query: s.nonEmptyString("The keyword used to search places."),
  ...
  action(
    ...
    s.requiredObject("Input parameters for input suggestions.", {
