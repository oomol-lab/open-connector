...
## Обзор локальной консоли

OpenConnector включает локальную Web Console для просмотра providers, настройки credentials,
создания runtime tokens и проверки run logs.

![Локальная консоль OpenConnector](../assets/open-console-en.jpg)
